...
main_menu_buttons = [KeyboardButton("Получение карт"), KeyboardButton("Коллекция"), KeyboardButton("Другое")]
...
collection_menu_buttons = [KeyboardButton("Список карт"), KeyboardButton("Просмотр карт"),
